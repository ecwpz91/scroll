...
/*
 * Demonstrates how to overload methods using the difference of
 * the number, type of arguments, or both.
 */
...
class Box {
	...
	//Constructor example, in turn would have to instantiate with
	//specific values for x1, y2, y1, y2, ect...
	//Box rect = new Box(25, 25, 50, 50);
	//rect = new Box(new Point(10, 10), new Point(20, 20);
	//rect = new Box(new Point(10, 10), 50, 50);
	...
	public static void main(String[] args) {
		...
		System.out.println("\nCalling buildBox with 1 point (10,10), " +
