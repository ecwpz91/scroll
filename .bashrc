...
########################################################################
# Author(s):   Balaji S. Srinivasan (balajis@stanford.edu),
#              Michael J. Surbey (michael@surbey.com)
# Description:
#
...
#
#   4) Optionally .bashrc imports .bashrc_aliases, .bashrc_exports, and
#      which can be used to override variables specified here.
#
...
# ----------------------------------------------------------------------
# Set prompt and record external history
# ----------------------------------------------------------------------
